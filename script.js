...
function calcularStatusBase(atributos) {
  ...
  // BASE (igual você passou)
  // HP 120/120 (+2 VIG = 20HP -> +10 por VIG)
  // MP 140/140 (+1 INT = 20MP -> +20 por INT)
  // COS 100/100 (+1 INT +1 AUR = 20 -> +10 por soma)
  // KI 130/130 (+2 FOR = 20KI -> +10 por FOR)
  // CK 30/30 (+1 AUR = 10CK -> +10 por AUR)
  return {
    HP: 120 + (VIG * 10),
    MP: 140 + (INT * 20),
    COS: 100 + ((INT + AUR) * 10),
